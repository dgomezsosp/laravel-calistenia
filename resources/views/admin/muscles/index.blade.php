      ...
      <header class="header-component">
        <div class="header-content">
          ...
          <div class="title-component">
            <h2>Panel de administración de {{ __('admin/titles.muscles') }}</h2>
          </div>
              ...
              @foreach($records as $record)
                <div class="table__body__user-box">
                  <div class="user-box__upper-row">
                    <button class="edit-button" data-endpoint="{{ route('muscles_edit', $record->id) }}">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <title>editar</title>
                        <path d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z" />
                      </svg>
                    </button>
                    <button class="delete-button" data-endpoint="{{ route('muscles_destroy', $record->id) }}">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <section class="form-component">
          <div class="form">
            ...
            <div class="form__body">
              ...
              <form action="{{ route('muscles_store') }}">
